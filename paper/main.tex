...
\textbf{Q-Shield (Siamese)} & \textbf{0.9254} & \textbf{0.8580} & \textbf{0.1656} & \textbf{2.9M} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{A1: Full Q-Shield (ours)} & \textbf{0.9254} & \textbf{0.8576} & \textbf{0.1662} \\
A2: No Siamese pretraining      & 0.8764 & 0.7851 & 0.2670 \\
A3: BCE loss (no focal)         & 0.8771 & 0.7857 & 0.2705 \\
A4: No frozen start             & 0.8810 & 0.8006 & 0.2298 \\
A5: Small head (256$\to$64$\to$1) & 0.8752 & 0.7943 & 0.2290 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
CV1: Train CIC $\to$ Test Trad      & 0.7178 & 0.6658 & 0.0000 \\
CV2: Train Trad $\to$ Test CIC      & 0.5181 & 0.5166 & 0.4917 \\
\textbf{CV3: Train combined $\to$ Test combined} & \textbf{0.9254} & \textbf{0.8576} & \textbf{0.1662} \\
\bottomrule
\end{tabular}
\end{table}
